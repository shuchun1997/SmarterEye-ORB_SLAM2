...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, "/zkhy_stereo/left/gray", 1);
    message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, "/zkhy_stereo/right/gray", 1);
